...
def evaluate_results(E, G, batch_size, current_time, prefix, final_z, final_targets, trainset, targets_single_id, save_dir):
    ...
    filename_precision = write_precision_list(
        f'{prefix}/{current_time}/precision_list',
        precision_list)
    ...
    filename_distance = write_precision_list(
        f'{prefix}/{current_time}/distance_facenet',
        mean_distances_list)
    ...
    log_final_images_local(target_id,
                           ...
                           log_target_confidences,
                           idx_to_class,
                           save_dir, nrow=num_imgs)

    log_nearest_neighbors_local(target_id,
                                log_imgs,
                                log_targets,
                                evaluater_facenet,
                                save_dir=save_dir, nrow=num_imgs)
