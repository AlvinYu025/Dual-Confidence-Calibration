...
class AttackConfigParser:
    ...
    def create_dataset(self, mode="KEDMI"):
        ...
        if name == 'celeba_identities':
            if mode == "test_ood":
                ...
                data_transformation_gan = self.create_transformations(mode='KEDMI',
                                                                      normalize=False)
                gan_set = CelebA_OOD(mode='aux_ood',
                                     transform=data_transformation_gan)
    ...
    def create_target_model(self):
        if 'wandb_target_run' in self._config:
            ...
            model = Classifier(num_classes=config['num_classes'],
                               ...
                               bido_args=config["bido"],
                               OE_args=config["outlier_exp"])
    ...
    def get_target_dataset(self):
        try:
            ...
            return self._config['dataset']['type']
